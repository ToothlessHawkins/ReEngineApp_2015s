...
#pragma endregion
	...
	if (m_bFPC) {
		...
		//myCam->ChangeYaw(fAngleY * 3.0f); // commented out because ChangeYaw doesn't work
		//myCam->ChangePitch(-fAngleX * 3.0f); // commented out because ChangePitch doesn't work
